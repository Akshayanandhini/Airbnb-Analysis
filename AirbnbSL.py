...
def datafr():
    df= pd.read_csv("C:\\Users\\DELL\\Desktop\\MANU\\placement\\Airbnb\\AirbnbFinal.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:\\Users\\DELL\\Desktop\\MANU\\placement\\Airbnb\\abnb.png")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:\\Users\\DELL\\Desktop\\MANU\\placement\\Airbnb\\AirbnbFinal.csv")
            return df_a
